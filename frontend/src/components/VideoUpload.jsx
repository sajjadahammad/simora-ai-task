    ...
    <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-lg p-4 md:p-5 h-full">
      ...
      {uploadedVideo && (
        <div className="mt-4 p-4 bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-xl">
          ...
          <button 
            className="w-full py-2.5 bg-gradient-to-r from-purple-400 to-pink-400 text-white font-medium rounded-lg hover:from-purple-500 hover:to-pink-500 transition-all shadow-sm hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed text-sm"
            onClick={handleReset}
